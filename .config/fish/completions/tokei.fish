# Written against `tokei --help`, version 12.1.2 compiled with support for CBOR, JSON, and YAML
...
complete -c tokei -s C -l compact -d 'Do not print statistics about embedded languages'
...
complete -c tokei -l no-ignore-dot -d 'Don’t respect .ignore and .tokeignore files, including those in parent directories'
...
complete -c tokei -x -s n -l num-format -d 'Format of printed numbers' -ka '(echo "plain	1234, default
commas	1,234
dots	1.234
underscores	1_234")' 
